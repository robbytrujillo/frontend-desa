                    ...
                    <div class="row">
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-primary text-white mb-4 border-0 shadow-sm">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <Link class="small text-white stretched-link" to="/admin/categories">
                                        View Details
                                    </Link>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-warning text-white mb-4 border-0 shadow-sm">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <Link class="small text-white stretched-link" to="/admin/posts">
                                    View Details
                                    </Link>
                                    <div class="small text-white">
                                        <i class="fas fa-angle-right"></i>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-success text-white mb-4 border-0 shadow-sm">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <Link class="small text-white stretched-link" to="/admin/products">
                                        View Details
                                    </Link>
                                    <div class="small text-white">
                                        <i class="fas fa-angle-right"></i>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-danger text-white mb-4 border-0 shadow-sm">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <Link class="small text-white stretched-link" to="/admin/aparaturs">
                                        View Details
                                    </Link>
                                    <div class="small text-white">
                                        <i class="fas fa-angle-right"></i>
